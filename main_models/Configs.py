...
flags.DEFINE_integer('training_epoch', 300, 'trianing epochs')
...
flags.DEFINE_integer('n_part_caps', 64, 'Number of part capsules.')
...
flags.DEFINE_integer('n_obj_caps', 64, 'Number of object capsules.')
flags.DEFINE_integer('n_obj_caps_params', 512, 'Dimensionality of object caps '
                     'feature vector.')
